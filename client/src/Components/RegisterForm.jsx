...
const RegisterForm = ({setUserId}) => {
    ...
    return (
      <div className="d-flex justify-content-center align-items-center ">
        ...
        <h1 className="col-6 offset-3 row" >Register</h1>
        <form className="col-6 offset-3 row" onSubmit={handleSubmit}>
        ...
        <input 
          ...
          />
        <p id="uidnote" className={firstNameFocus && firstName && !validFirstName ? "instructions" : "d-none"}>
        ...
        <input 
          ...
          />
        <p id="uidnote" className={lastNameFocus && lastName && !validLastName ? "instructions" : "d-none"}>
          Must begin with a letter.<br/>
          Letters, hyphens, commas or apostrophes allowed.
          </p>
        ...
        <input 
          ...
          />
        <p id="emailnote" className={emailFocus && email && !validEmail ? "instructions" : "d-none"}>
          ...
          <input
            ...
            <p id="pwdmsg" className={pwdFocus && !validPwd ? "instructions" : "d-none"}>
            ...
            <p id="confirm" className={matchFocus && !validMatch ? "instructions" : "d-none"}>
